...
<style>
    ...
    .form-control:focus { background: rgba(255,255,255,0.1); color: white; border-color: var(--accent); outline: none; }
    label { margin-bottom: 0.5rem; font-weight: 500; }
</style>

<div class="container mt-5">
    <div class="glass-card">
        <h3 class="text-accent mb-4">Ajouter un Véhicule au Parc</h3>
        <form action="?url=vehicules_store" method="POST">
            ...
            <div class="mt-4">
                ...
                <a href="?url=vehicules_index" class="btn btn-outline-light px-4 ms-2">Annuler</a>
            </div>
        </form>
    </div>
</div>
